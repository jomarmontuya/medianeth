...
export default function Navbar() {
  ...
  return (
    <>
      <section className="text-mainColor border-b ">
        <div className="container mx-auto py-5">
            ...
            <div className="hidden lg:flex xl:w-3/5 mx-auto justify-center gap-10 items-center">
              ...
              <div className="hidden lg:flex xl:hidden">
                <Link
                  ...
                  className="bg-mainColor3 py-2 px-5 flex justify-end text-white w-32 xl:w-auto"
                >
                  Let&apos;s Talk
          ...
          <div
            className={
              nav
                ? "flex flex-col xl:w-3/5 mx-auto justify-center gap-10 items-center mt-5 text-center"
                : "hidden"
            }
          >
            <Link
              href="https://www.google.com"
              className="hover:bg-mainColor3 w-full hover:text-white py-2"
            >
              Home
            </Link>
            <Link
